...
type-check:
	...
	uv run mypy binarypilot/
	@echo "🔍 Type checking with pyright..."
	uv run pyright binarypilot/
	@echo "✅ Type checking complete!"

security:
	@echo "🔒 Running security checks with bandit..."
	uv run bandit -r binarypilot/ -c pyproject.toml
...
viewer:
	...
	cd binarypilot/interface/viewer/frontend && npm ci && npm run build
	@echo "✅ Viewer built to binarypilot/interface/viewer/static/ (commit the changes)."
