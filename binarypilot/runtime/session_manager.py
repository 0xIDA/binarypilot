...
from binarypilot.runtime.backends import backend_supports_bind_mounts, get_backend
from binarypilot.runtime.caido_bootstrap import bootstrap_caido
...
def _host_identity_env() -> dict[str, str]:
    if sys.platform != "linux":
        return {}
    return {"BINARYPILOT_HOST_UID": str(os.getuid()), "BINARYPILOT_HOST_GID": str(os.getgid())}
    ...
    manifest = Manifest(
        ...
        environment=Environment(
            value={
                ...
                **_host_identity_env(),
                **load_settings().platforms.sandbox_env(),
