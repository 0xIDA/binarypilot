...
from binarypilot.core.paths import run_dir_for
from binarypilot.report.sarif import write_sarif
from binarypilot.report.usage import LLMUsageLedger
...
def _binarypilot_version() -> str | None:
...
class ReportState:
    ...
    persistence. This store keeps only BinaryPilot-owned scan artifacts and
        ...
        try:
            ...
            try:
                write_sarif(
                    ...
                    tool_version=_binarypilot_version(),
...
class StreamedOpenRouterCosts:
    ...
    scan streams, so the OpenRouter streaming handler (see binarypilot.config.models)
