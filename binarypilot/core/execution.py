"""Execution loop for addressable SDK-backed BinaryPilot agents."""
...
from binarypilot.core.hooks import (
    BudgetExceededError,
    BudgetPausedError,
    SubagentBudgetReservedError,
)
from binarypilot.core.inputs import child_initial_input
from binarypilot.core.sessions import (
...
from binarypilot.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from binarypilot.core.agents import AgentCoordinator, Status
...
async def _append_tool_required_message(
    *,
    ...
    if interactive:
        ...
        message = (
            "Your previous response ended the autonomous BinaryPilot run without a lifecycle tool "
