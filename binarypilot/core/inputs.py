"""Pure input builders for BinaryPilot scan runs."""
...
from binarypilot.core.sessions import scrub_images_from_items


if TYPE_CHECKING:
    from binarypilot.config.settings import ReasoningEffort
