...
export const SIGNUP_URL = "https://app.binarypilot.ai/api/auth/signup";
export const DEMO_URL = "https://binarypilot.ai/demo";
export const PRICING_URL = "https://binarypilot.ai/pricing";
