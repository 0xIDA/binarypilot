// Slim, dependency-free extract of binarypilot-app's display-number helper. The full
...
export function formatBinaryPilotId(num: number): string {
  return `BINARYPILOT-${num}`;
}
