 ...
 *
 * The OSS binarypilot engine (usebinarypilot/binarypilot) is the source of truth for tool names:
 * see `binarypilot/tools/**` for definitions and `binarypilot/interface/tui/renderers/` for
...
const CATEGORY_TOOLS: Record<ToolCategory, readonly string[]> = {
  ...
  search: ["web_search"],
  // scan_start_info / subagent_start_info are binarypilot-app synthetic events; finish_scan is the engine's
