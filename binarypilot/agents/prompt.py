...
from binarypilot.skills import get_available_skills, load_skills, skill_search_dirs
from binarypilot.utils.resource_paths import get_binarypilot_resource_path
...
def render_system_prompt(
    *,
    ...
    try:
        prompt_dir = get_binarypilot_resource_path("agents", _PROMPT_DIRNAME)
