...
Skip the setup. Run BinaryPilot in the cloud at [app.binarypilot.ai](https://app.binarypilot.ai).
...
1. Sign up at [app.binarypilot.ai](https://app.binarypilot.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try BinaryPilot Cloud" icon="rocket" href="https://app.binarypilot.ai">
