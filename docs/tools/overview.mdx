---
title: "Agent Tools"
description: "How BinaryPilot agents interact with targets"
---

BinaryPilot agents use specialized tools to test your applications like a real penetration tester would.
