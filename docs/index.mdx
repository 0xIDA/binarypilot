...
BinaryPilot agents come equipped with a comprehensive toolkit:
...
BinaryPilot uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/binarypilot-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub" icon="github" href="https://github.com/usebinarypilot/binarypilot">
