---
title: "AWS Bedrock"
description: "Configure BinaryPilot with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install BinaryPilot with the bedrock extra:

```bash
pipx install "binarypilot-agent[bedrock]"
```

## Setup

```bash
export BINARYPILOT_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
