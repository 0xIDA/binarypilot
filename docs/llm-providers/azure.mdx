---
title: "Azure OpenAI"
description: "Configure BinaryPilot with OpenAI models via Azure"
---

## Setup

```bash
export BINARYPILOT_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `BINARYPILOT_LLM` | `azure/<your-deployment-name>` |
...
```bash
export BINARYPILOT_LLM="azure/gpt-5.4-deployment"
