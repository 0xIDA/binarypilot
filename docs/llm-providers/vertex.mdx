...
description: "Configure BinaryPilot with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install BinaryPilot with the vertex extra:

```bash
pipx install "binarypilot-agent[vertex]"
```

## Setup

```bash
export BINARYPILOT_LLM="vertex_ai/gemini-3-pro-preview"
```
