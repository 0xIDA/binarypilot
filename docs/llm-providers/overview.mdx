---
title: "Overview"
description: "Configure your AI model for BinaryPilot"
---

BinaryPilot uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export BINARYPILOT_LLM="ollama/llama4"
