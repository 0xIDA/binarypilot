---
title: "Contributing"
description: "Contribute to BinaryPilot development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `binarypilot/skills/`
...
- BinaryPilot version (`binarypilot --version`)
- LLM being used
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/usebinarypilot/binarypilot/issues">
