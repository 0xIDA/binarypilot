...
description: "Guide BinaryPilot with custom testing instructions"
---
...
```bash
binarypilot --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
binarypilot --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
binarypilot --target https://app.com \
...
```bash
binarypilot --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help BinaryPilot prioritize the most valuable attack paths.
</Tip>
