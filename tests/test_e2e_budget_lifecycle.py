...
from binarypilot.core.agents import AgentCoordinator, WaitKind
from binarypilot.core.execution import _start_child_runner, run_agent_loop
from binarypilot.core.hooks import BudgetExceededError, ReportUsageHooks
...
async def test_full_budget_lifecycle_reserve_then_cap(  # noqa: PLR0915
    ...
    with patch("binarypilot.core.hooks.get_global_report_state", return_value=ledger):
