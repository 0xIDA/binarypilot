"""STRIDE-leg tagging in the SARIF emitter (binarypilot.report.sarif).
...
from binarypilot.report.sarif import (
    _CWE_TO_STRIDE,
...
def test_stride_tags_attach_to_rule_not_duplicated_on_result() -> None:
    ...
    its own binarypilot.* properties, not a redundant tags copy."""
