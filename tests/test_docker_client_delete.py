"""BinaryPilotDockerSandboxClient.delete() best-effort teardown.
...
def _client_with_kill_error(exc: Exception) -> BinaryPilotDockerSandboxClient:
    """A BinaryPilotDockerSandboxClient whose containers.get(...).kill() raises ``exc``."""
    client = BinaryPilotDockerSandboxClient.__new__(BinaryPilotDockerSandboxClient)
